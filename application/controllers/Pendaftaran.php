...
class Pendaftaran extends CI_Controller {
    ...
    private function _validInputPendaftaran()
    {
		...
		$this->form_validation->set_rules('comfirmPassword', 'Comfirm Password', 'trim|required|min_length[8]|matches[password]',
			[
	...
	public function Daftar()
	{
        ...
        //Jika Data Valid
        	...
        	$validasi = [
                ...
                'comfirmPassword_error' => form_error('comfirmPassword'),
            ];
            echo json_encode($validasi);
        }
