...
class BankSoal extends CI_Controller {
	...
	// Validasi Update Data Bank Soal
	...
	{ 
		$link = "
			<a href='".base_url('banksoal/update/'.$idKategoriSoal.'/'.$idBankSoal)."' data-toggle='tooltip' data-placement='top' class='btn-edit' title='Update' value='".$idBankSoal."'>
	      	...
	      	<a href='".base_url('banksoal/delete/'.$idKategoriSoal.'/'.$idBankSoal)."' class='btn-delete' data-toggle='tooltip' data-placement='top' title='Delete'>
...
/* Location: ./application/controllers/BankSoal.php */
