      					...
      					<div class="container">
      						...
      						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
      							<ul class="nav navbar-nav menu_nav ml-auto">  
      								<li class="nav-item"><a class="nav-link" href="<?php echo base_url('profil/logout'); ?>">Logout</a></li>
      							</ul>
      						</div> 
      					</div>
            	</nav>
            ...
            <div class="container">
                <div class="row">
                  <!-- Profil Member -->
                    <div class="col-lg-4">
                        <div class="blog_right_sidebar">
                            <aside class="single_sidebar_widget author_widget">
                                <img class="author_img rounded-circle" src="<?php echo base_url(); ?>assets/bulkapp/img/blog/author.png" alt="">
                            ...
                            <aside class="single_sidebar_widget author_widget">
                              <h4>Nilai Ambang Batas Seleksi Kompetensi Dasar (SKD)</h4>
                              <p>
                                Berdasarkan Peraturan Menteri Pendayagunaan Aparatur Negara dan Reformasi Birokrasi Republik Indonesia Nomor 24 Tahun 2019 Tentang Nilai Ambang Batas Seleksi Kompetensi Dasar Pengadaan Calon Pegawai Negeri Sipil Tahu 2019, adalah sebagai berikut:
                              </p>
                              <div class="br"></div>
                          </aside>
                    ...
                    <div class="col-lg-8">
                      <div class="container">
                        <!-- Daftar Riwayat Nilai Ujian Simulasi CAT -->
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                              <thead class="table-head">
                                <tr>
                                  <th scope="col">#</th>
                                  <th scope="col">Pelaksanaan Simulasi</th>
                                  <?php 
