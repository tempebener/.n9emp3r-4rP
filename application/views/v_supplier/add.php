          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <textarea class="textarea" placeholder="Place some text here" id="pertanyaan" name="pertanyaan" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required></textarea>
