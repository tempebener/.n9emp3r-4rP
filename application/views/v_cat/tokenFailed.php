        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active text-danger">Token Simulasi CAT Failed</li>
            </ol>
          </div>  <!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="error-page">
        ...
        <div class="error-content">
          ...
          <a href="<?php echo base_url('accessdenied/gohome'); ?>">
            <button type="button" class="btn btn-block btn-outline-warning btn-lg"><i class="fas fa-sign-out-alt"></i> Go Home! </button>
          </a>
        </div>
      </div>
      <!-- /.error-page -->
