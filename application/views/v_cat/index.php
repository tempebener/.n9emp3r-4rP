...
<div class="wrapper">
    ...
    <div class="container">
      <a href="" class="navbar-brand">
        <img src="<?php echo base_url(); ?>assets/adminlte3/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
             style="opacity: .8">
        <span class="brand-text font-weight-light">Sumulasi</span>
      </a>
    </div>
  </nav>
  <!-- /.navbar -->
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"><?php echo $namaUser; ?></li>
            </ol>
          </div>  <!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="clock" style="margin:2em;"></div><!-- /.Flipclock -->
              ...
              <?php echo form_open('cat/simpanJawaban/'. $idSimulasi.'/'.$noSoal); ?>
                ...
                <div class="card-footer">
                  ...
                  <?php
                    //Lewati Soal 
                    $next = $noSoal+1;
                    echo "<a href='".base_url('cat/index?tokenSimulasi='.urlencode($token).'&noSoal='. $next)."'>
                            <button type='button' class='btn btn-outline-secondary'>Lewati</button>
                          </a>";
                  ?>
                </div>
              </form>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; <script>document.write(new Date().getFullYear());</script> <a href="">Bang Ambo</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
